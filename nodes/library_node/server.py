...
class ResourceService(resource_pb2_grpc.ResourceServiceServicer):
    ...
    def __init__(self):
        self.resources = [
            resource_pb2.Resource(
                ...
                subject="Python",
                description="Study guide covering Python programming fundamentals.",
            ...
            resource_pb2.Resource(
                ...
                description="Reference material covering networking concepts and protocols.",
            ...
            resource_pb2.Resource(
                ...
                subject="DSA",
                description="Reference material for data structures and algorithmic problem solving.",
                resource_type="Notes",
                author="Library Collection",
                node_id=NODE_ID
            )
    ...
    def AddResource(self, request, context):
        resource_id = f"LIB-RES-{len(self.resources) + 1:03d}"
